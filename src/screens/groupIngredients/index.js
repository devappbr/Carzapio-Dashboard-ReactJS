...
import AddGroupIngredients from './add';

class GroupIngredients extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    _getData = async () => {
        ...
        try {
            ...
            axios.all([
                await axios.get(`${baseLocal}${getGroupIngredients}`, authPassed),
            ...
            <div style={{ width: '100%' }}>
                ...
                {this.state.data.length > 0 ?
                    <main className='content'>
                        <ListView
                            title='LISTAGEM DE GRUPO DE INGREDIENTES'
